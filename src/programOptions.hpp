...
struct ProgramOptions
{
    ...
    UDataPacketService::OTelOptions::HTTPMetrics otelHTTPMetricsOptions;
    UDataPacketService::OTelOptions::HTTPLog otelHTTPLogOptions;
    UDataPacketService::OTelOptions::GRPCMetrics otelGRPCMetricsOptions;
    UDataPacketService::OTelOptions::GRPCLog otelGRPCLogOptions;
...
ProgramOptions parseIniFile(const std::filesystem::path &iniFile)
{
    ...
    {
        UDataPacketService::OTelOptions::HTTPLog logOptions;
        logOptions.url
...
#endif
        UDataPacketService::OTelOptions::GRPCLog logOptions;
        logOptions.url
    ...
    {
        UDataPacketService::OTelOptions::HTTPMetrics metricsOptions;
        metricsOptions.url
...
#endif
        UDataPacketService::OTelOptions::GRPCMetrics metricsOptions;
        metricsOptions.url
